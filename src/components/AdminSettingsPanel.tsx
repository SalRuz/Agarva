...
const SECTIONS: SectionDef[] = [
  {
    ...
    fields: [
      ...
      {
        key: 'classicRecordCheckIntervalSec',
        label: 'Интервал проверки рекорда классика (сек)',
        help: 'Как часто сервер проверяет новый рекорд и может отправить объявление в чат (1–3600 сек).',
        step: 1,
      },
